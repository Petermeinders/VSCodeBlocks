...
<main>
  <div class="SearchBox" style="display:flex; align-items: center; background: #3c3c3c">
    <button style="background:#3c3c3c;" on:click={ClearSearchInput}
      ><Fa icon={faTimesCircle} style="color:white; padding-right: 4px; padding-left: 4px; cursor:pointer;" /></button
    >
    <input
      id="CodeBlocksSearchInput"
      type="text"
      placeholder="Search"
      value={$searchTerm ?? ""}
